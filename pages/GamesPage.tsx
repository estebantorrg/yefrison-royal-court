          ...
          <div className="animate-fade-in-up relative z-10" key="menu">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl mx-auto h-full">
              ...
              >
                ...
                <div className="absolute inset-0 bg-[url('/yefris_laser.png')] bg-cover bg-center mix-blend-screen opacity-10 group-hover:opacity-30 transition-all duration-700 group-hover:scale-110" />
              ...
              >
                ...
                <div className="absolute inset-0 bg-[url('/homun.webp')] bg-cover bg-center mix-blend-screen opacity-10 group-hover:opacity-40 transition-all duration-700 blur-[2px] group-hover:blur-none group-hover:scale-105" />
